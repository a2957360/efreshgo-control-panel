...
function DoubleAdsHeader(props) {
	...
	return (
		<div className="flex flex-1 w-full items-center justify-between">
			...
			<FuseAnimate animation="transition.slideRightIn" delay={300}>
				<Button
					component={Link}
					to="/homepage/doublead/new"
					className="whitespace-no-wrap normal-case"
					variant="contained"
                    color="secondary"
                    disabled={data.componentContent.Zh.length === 2}
				>
					<span className="hidden sm:flex">新增广告</span>
...
export default DoubleAdsHeader;
