...
import SectionAdsTableHeader from './SectionAdsTableHeader';

const SectionAdsTable = props => {
									...
									return (
										<TableRow key={index.toString()}>
											...
											<TableCell className="w-80" align="center">
												<img src={ad.uri} className='w-full' alt={`ad_${index}`} />
											</TableCell>
											<TableCell className="w-80" align="center">
												<img src={ad.uri_en} className='w-full' alt={`ad_en_${index}`} />
											</TableCell>
											<TableCell align="center">{link}</TableCell>
											<TableCell align="center">
												<Button
													component={Link}
													to={`/homepage/sectionadvertisement/${index}`}
...
export default SectionAdsTable;
