...
const headers = [
	...
	{ label: '本日销量', key: 'itemQuantity' },
	{ label: '本日销售额', key: 'totalPrice' },
	{ label: '累计销量', key: 'amountSale' },
	{ label: '累计销售额', key: 'amountPrice' },
];

function DailyReportHeader(props) {
	// const dispatch = useDispatch();
	// const searchText = useSelector(({ main }) => main.carousels.searchText);
	const mainTheme = useSelector(selectMainTheme);

	const { data, stores, storeNumber, setStoreNumber, startDate, endDate } = props;
